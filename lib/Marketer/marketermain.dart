...
class marketer extends StatefulWidget {
  final drawerItems = [
    ...
    new DrawerItem("Leads", Icons.local_pizza),
    new DrawerItem("Quotations", Icons.info),
    new DrawerItem("Sales", Icons.info),
    new DrawerItem("Follow ups", Icons.info),
...
class HomePageState extends State<marketer> {
